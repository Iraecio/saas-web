    ...
    <div class="p-6 space-y-6">
      ...
      <section class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        @for (stat of stats; track stat.label) {
          <div
            class="rounded-xl bg-white p-5 shadow-sm ring-1 ring-neutral-200 dark:bg-neutral-800 dark:ring-neutral-700"
          >
      ...
      <section class="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <div
          class="lg:col-span-2 rounded-xl bg-white shadow-sm ring-1 ring-neutral-200 dark:bg-neutral-800 dark:ring-neutral-700 overflow-hidden"
        >
          <div
            class="border-b border-neutral-200 px-5 py-4 dark:border-neutral-700 flex justify-between items-center"
          >
              ...
              <li class="flex items-center justify-between px-5 py-4 text-sm">
                <div class="flex items-center gap-3">
                  <span
                    ...
                    [class]="order.urgent ? 'bg-red-100' : 'bg-blue-100'"
                  >
                    {{ order.urgent ? '🔥' : '📝' }}
                  </span>
                  <div>
                    ...
                    <p class="text-xs text-neutral-400">
                      {{ order.type }} · {{ order.words }} palavras
                    </p>
                  </div>
                </div>
                <div class="flex items-center gap-3">
        ...
        <div
          class="rounded-xl bg-white shadow-sm ring-1 ring-neutral-200 dark:bg-neutral-800 dark:ring-neutral-700 overflow-hidden"
        >
          ...
          <div class="border-t border-neutral-200 px-5 py-3 dark:border-neutral-700">
            <a routerLink="/admin/history" class="text-xs text-blue-500 hover:underline"
      ...
      <section>
        ...
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
          <a
            routerLink="/admin/professionals/my-services"
          ...
          >
            ...
            <div>
              <p class="text-sm font-semibold text-neutral-900 dark:text-white">Meus Serviços</p>
              <p class="text-xs text-neutral-500">Gerenciar ofertas e valores</p>
            </div>
          </a>
          <a
            routerLink="/admin/profile/voice"
...
export class VoiceActorDashboardComponent {
  ...
  protected readonly queue = [
    {
      id: 1,
      client: 'Rádio Hits FM',
      type: 'Spot com produção',
      words: 120,
      deadline: '🔥 10min',
      urgent: true,
    },
